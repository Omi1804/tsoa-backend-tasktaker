...
let TodoController = class TodoController extends tsoa_1.Controller {
    getTodo(todoId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let todoService = new todoService_1.TodoService(); //creating object of the class
...
exports.TodoController = TodoController = __decorate([
    (0, tsoa_1.Route)("todo") //this controller is responsible for creating the routes related to "/todo" endpoints---> similiar to app.use("/todo",todoroutes);
], TodoController);
